...
class RequiredApplicationModifyAppearanceRequest(TypedDict):
    pass

class OptionalApplicationModifyAppearanceRequest(TypedDict, total=False):
...
class ApplicationModifyAppearanceRequest(RequiredApplicationModifyAppearanceRequest, OptionalApplicationModifyAppearanceRequest):
    pass
