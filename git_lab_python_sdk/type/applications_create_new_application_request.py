...
class RequiredApplicationsCreateNewApplicationRequest(TypedDict):
...
class OptionalApplicationsCreateNewApplicationRequest(TypedDict, total=False):
...
class ApplicationsCreateNewApplicationRequest(RequiredApplicationsCreateNewApplicationRequest, OptionalApplicationsCreateNewApplicationRequest):
    pass
