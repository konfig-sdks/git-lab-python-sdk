...
from git_lab_python_sdk.model.branches_get_all_response import BranchesGetAllResponse as BranchesGetAllResponseSchema

from git_lab_python_sdk.type.branches_get_all_response import BranchesGetAllResponse

from ...api_client import Dictionary
from git_lab_python_sdk.pydantic.branches_get_all_response import BranchesGetAllResponse as BranchesGetAllResponsePydantic
...
class SortSchema(
    ...
    @schemas.classproperty
    def UPDATED_ASC(cls):
        return cls("updated_asc")
    
    @schemas.classproperty
    def UPDATED_DESC(cls):
        return cls("updated_desc")
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'regex': typing.Union[RegexSchema, str, ],
...
request_query_regex = api_client.QueryParameter(
    name="regex",
    style=api_client.ParameterStyle.FORM,
    schema=RegexSchema,
    explode=True,
...
SchemaFor200ResponseBodyApplicationJson = BranchesGetAllResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: BranchesGetAllResponse
    ...
    async def _aget_all_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v4/projects/{id}/repository/branches',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetAll(BaseApi):
    ...
    async def aget_all(
        ...
        validate: bool = False,
        **kwargs,
    ) -> BranchesGetAllResponsePydantic:
        ...
        if validate:
            return RootModel[BranchesGetAllResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(BranchesGetAllResponsePydantic, raw_response.body)
