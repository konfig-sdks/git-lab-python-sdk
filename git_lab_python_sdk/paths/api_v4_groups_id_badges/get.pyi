...
from git_lab_python_sdk.model.badges_get_list_response import BadgesGetListResponse as BadgesGetListResponseSchema

from git_lab_python_sdk.type.badges_get_list_response import BadgesGetListResponse

from ...api_client import Dictionary
from git_lab_python_sdk.pydantic.badges_get_list_response import BadgesGetListResponse as BadgesGetListResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = BadgesGetListResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: BadgesGetListResponse
...
class GetList(BaseApi):
    ...
    async def aget_list(
        ...
        **kwargs,
        ...
        if validate:
            return RootModel[BadgesGetListResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(BadgesGetListResponsePydantic, raw_response.body)
