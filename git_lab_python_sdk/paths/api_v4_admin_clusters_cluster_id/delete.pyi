...
SchemaFor204ResponseBodyApplicationJson = APIEntitiesClusterSchema
...
class BaseApi(api_client.Api):
    ...
    def _delete_instance_cluster_mapped_args(
        self,
        cluster_id: int,
    ...
    async def _adelete_instance_cluster_oapg(
        self,
    ...
    def _delete_instance_cluster_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class DeleteInstanceClusterRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_instance_cluster(
        self,
        cluster_id: int,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._delete_instance_cluster_mapped_args(
            cluster_id=cluster_id,
        )
        return await self._adelete_instance_cluster_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def delete_instance_cluster(
        self,
        cluster_id: int,
    ) -> typing.Union[
        ApiResponseFor204,
        ...
        return self._delete_instance_cluster_oapg(
            path_params=args.path,
        )

class DeleteInstanceCluster(BaseApi):
    ...
    async def adelete_instance_cluster(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_instance_cluster(
            cluster_id=cluster_id,
            **kwargs,
        )
        if validate:
    ...
    def delete_instance_cluster(
        ...
        raw_response = self.raw.delete_instance_cluster(
            cluster_id=cluster_id,
        )
        if validate:
            return APIEntitiesClusterPydantic(**raw_response.body)
