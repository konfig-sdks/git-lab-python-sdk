...
class BaseApi(api_client.Api):
    ...
    def _delete_message_mapped_args(
        self,
        id: int,
    ...
    async def _adelete_message_oapg(
        self,
...
class DeleteMessageRaw(BaseApi):
    ...
    async def adelete_message(
        ...
        **kwargs,
        ...
        args = self._delete_message_mapped_args(
            id=id,
        )
        return await self._adelete_message_oapg(
    ...
    def delete_message(
        ...
        return self._delete_message_oapg(
            path_params=args.path,
        )

class DeleteMessage(BaseApi):
    ...
    async def adelete_message(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_message(
            id=id,
            **kwargs,
        )
        if validate:
    ...
    def delete_message(
        ...
        raw_response = self.raw.delete_message(
            id=id,
        )
        if validate:
            return APIEntitiesBroadcastMessagePydantic(**raw_response.body)
