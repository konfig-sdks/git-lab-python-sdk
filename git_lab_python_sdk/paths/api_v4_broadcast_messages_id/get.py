...
class BaseApi(api_client.Api):
    ...
    def _get_specific_message_mapped_args(
        self,
        id: int,
    ...
    async def _aget_specific_message_oapg(
        self,
    ...
    def _get_specific_message_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetSpecificMessageRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_specific_message(
        self,
        id: int,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_specific_message_mapped_args(
            id=id,
        )
        return await self._aget_specific_message_oapg(
    ...
    def get_specific_message(
        ...
        return self._get_specific_message_oapg(
            path_params=args.path,
        )

class GetSpecificMessage(BaseApi):
    ...
    async def aget_specific_message(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_specific_message(
            id=id,
            **kwargs,
        )
        if validate:
    ...
    def get_specific_message(
        ...
        raw_response = self.raw.get_specific_message(
            id=id,
        )
        if validate:
            return APIEntitiesBroadcastMessagePydantic(**raw_response.body)
