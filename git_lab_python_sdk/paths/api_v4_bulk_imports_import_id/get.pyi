...
class BaseApi(api_client.Api):
    ...
    def _get_migration_details_mapped_args(
        self,
        import_id: int,
    ...
    async def _aget_migration_details_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v4/bulk_imports/{import_id}',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_migration_details_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetMigrationDetailsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_migration_details(
        self,
        import_id: int,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_migration_details_mapped_args(
            import_id=import_id,
        )
        return await self._aget_migration_details_oapg(
    ...
    def get_migration_details(
        ...
        return self._get_migration_details_oapg(
            path_params=args.path,
        )

class GetMigrationDetails(BaseApi):
    ...
    async def aget_migration_details(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_migration_details(
            import_id=import_id,
            **kwargs,
        )
        if validate:
    ...
    def get_migration_details(
        ...
        raw_response = self.raw.get_migration_details(
            import_id=import_id,
        )
        if validate:
            return APIEntitiesBulkImportPydantic(**raw_response.body)
