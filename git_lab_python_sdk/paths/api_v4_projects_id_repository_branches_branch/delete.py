...
class BaseApi(api_client.Api):
    ...
    def _delete_branch_mapped_args(
        self,
        id: str,
        branch: str,
    ...
    async def _adelete_branch_oapg(
        self,
...
class DeleteBranchRaw(BaseApi):
    ...
    async def adelete_branch(
        ...
        **kwargs,
        ...
        args = self._delete_branch_mapped_args(
            id=id,
            branch=branch,
        )
        return await self._adelete_branch_oapg(
...
class DeleteBranch(BaseApi):
    ...
    async def adelete_branch(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_branch(
            id=id,
            branch=branch,
            **kwargs,
        )
    ...
    def delete_branch(
        ...
        raw_response = self.raw.delete_branch(
            id=id,
            branch=branch,
        )
