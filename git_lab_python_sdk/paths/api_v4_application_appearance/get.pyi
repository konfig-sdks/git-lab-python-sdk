...
class BaseApi(api_client.Api):
    ...
    def _get_current_appearance_mapped_args(
        self,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        return args

    async def _aget_current_appearance_oapg(
        self,
    ...
    def _get_current_appearance_oapg(
        self,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
...
class GetCurrentAppearanceRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_current_appearance(
        self,
        **kwargs,
    ) -> typing.Union[
        ApiResponseFor200Async,
        ...
        args = self._get_current_appearance_mapped_args(
        )
        return await self._aget_current_appearance_oapg(
            **kwargs,
        )
    
    def get_current_appearance(
        self,
    ) -> typing.Union[
        ApiResponseFor200,
        api_client.ApiResponseWithoutDeserialization,
        ...
        return self._get_current_appearance_oapg(
        )

class GetCurrentAppearance(BaseApi):
    ...
    async def aget_current_appearance(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_current_appearance(
            **kwargs,
        )
        if validate:
    ...
    def get_current_appearance(
        ...
        raw_response = self.raw.get_current_appearance(
        )
        if validate:
            return APIEntitiesAppearancePydantic(**raw_response.body)
        return api_client.construct_model_instance(APIEntitiesAppearancePydantic, raw_response.body)
