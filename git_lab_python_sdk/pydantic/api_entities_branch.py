...
class APIEntitiesBranch(BaseModel):
    ...
    merged: typing.Optional[bool] = Field(None, alias='merged')

    protected: typing.Optional[bool] = Field(None, alias='protected')

    developers_can_push: typing.Optional[bool] = Field(None, alias='developers_can_push')

    developers_can_merge: typing.Optional[bool] = Field(None, alias='developers_can_merge')

    can_push: typing.Optional[bool] = Field(None, alias='can_push')
