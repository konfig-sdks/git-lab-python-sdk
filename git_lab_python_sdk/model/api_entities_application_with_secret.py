...
class APIEntitiesApplicationWithSecret(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "application_id", "application_name", "callback_url", "confidential", "secret", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "application_id", "application_name", "callback_url", "confidential", "secret", ], str]):
