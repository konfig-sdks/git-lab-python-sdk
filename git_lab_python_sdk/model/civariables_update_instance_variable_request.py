...
class CivariablesUpdateInstanceVariableRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["value", "protected", "masked", "raw", "variable_type", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["value", "protected", "masked", "raw", "variable_type", ], str]):
