...
class APIEntitiesUserBasic(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "username", "name", "state", "avatar_url", "avatar_path", "custom_attributes", "web_url", "email", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "username", "name", "state", "avatar_url", "avatar_path", "custom_attributes", "web_url", "email", ], str]):
